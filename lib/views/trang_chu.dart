...
//                       builder:
//                           (context) => ProductFilterScreen(
//                             products: _allProducts, // Truyền toàn bộ sản phẩm
//                             loai: 0,
//                             gioiTinh: '',
//                             nhom: 'Sản phẩm ẩn',
//                             userData: widget.userData,
...
//       // Chỉ phần GridView trong HomeScreen - thay thế phần body hiện tại
//       body: Padding(
...
//                 products
//                     .where(
//                       (sp) => (sp.trangthai ?? 1) == 1 && sp.soluongKho > 0,
//                     )
//                     .toList();
...
//                           .where(
//                             (sp) =>
//                                 (sp.trangthai ?? 1) == 1 && sp.soluongKho > 0,
//                           )
//                           .toList(),
//                   loai: loai,
//                   gioiTinh: gioiTinh,
